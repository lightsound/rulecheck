 ...
 *   a well-formed region: opaque, never written, and every line inside it is ignored by this
 *   detection (a "Managed by X. Do not edit inside this block" line inside a region describes
 *   the region, not the file). Pairs that tell a formatter or linter to skip a span
