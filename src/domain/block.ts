 ...
 * name (three characters or more, and not one of the words that make a marker file-level in the
 * first place) appears as a whole word in the marker text. `<!-- Managed by solid2-agent-kit
 * v0.11.1 … -->` inside `solid2-agent-kit:agents-section` does (`solid2`); `<!-- Generated by
 * Skiller -->` inside `generated:task-matrix` does not (`generated` is excluded) and keeps its
 * blocking power.
 */
const GENERIC_WORDS = new Set(["managed", "generated", "autogenerated", "not", "edit"]);
