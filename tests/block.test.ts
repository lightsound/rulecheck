...
describe("findForeignMarkers", () => {
  ...
  test("a file-level marker inside a region is opaque only when it names the region's owner", () => {
    ...
    const generic = [
      ...
      "<!-- kit:end -->",
      "<!-- stripe-projects-cli managed:agents-md:start -->",
      "<!-- Managed by ruler. Do not edit AGENTS.md by hand -->",
      "<!-- stripe-projects-cli managed:agents-md:end -->",
      "<!-- fallow:agent-install v1 claude-import:start -->",
      "<!-- Generated by ruler; do not edit CLAUDE.md -->",
      "<!-- fallow:agent-install v1 claude-import:end -->",
      "<!-- auto-docs:start -->",
      "<!-- auto-generated by CoolGen -->",
      "<!-- auto-docs:end -->",
    ].join("\n");
    expect(findForeignMarkers("AGENTS.md", generic).issues.map((i) => i.line)).toEqual([
      2, 5, 8, 11, 14, 17,
    ]);
  });
